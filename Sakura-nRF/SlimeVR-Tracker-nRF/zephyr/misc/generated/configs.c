...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USE_SLIMENRF_CONSOLE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BATTERY_USE_REG_BUCK_MAPPING, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BATTERY_LOW_RUNTIME_THRESHOLD, 10800000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LED_TRI_COLOR, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_IGNORE_RESET, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USER_SHUTDOWN, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USE_IMU_WAKE_UP, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CONNECTION_TIMEOUT_DELAY, 300000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SENSOR_LP_TIMEOUT, 500);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USE_IMU_TIMEOUT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_IMU_TIMEOUT_RAMP_MIN, 5000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_IMU_TIMEOUT_RAMP_MAX, 15000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USE_ACTIVE_TIMEOUT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SLEEP_ON_ACTIVE_TIMEOUT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ACTIVE_TIMEOUT_THRESHOLD, 15000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ACTIVE_TIMEOUT_DELAY, 900000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SENSOR_ACCEL_ODR, 100);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SENSOR_GYRO_ODR, 200);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SENSOR_ACCEL_FS, 4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SENSOR_GYRO_FS, 1000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SENSOR_USE_MAG, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SENSOR_USE_VQF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SENSOR_USE_6_SIDE_CALIBRATION, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RADIO_TX_POWER, 8);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_PWM_CLOCK_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOG_BUFFER_SIZE, 1536);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ESB_DEFAULT_RF_CHANNEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SRAM_SIZE, 124);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PM_SRAM_SIZE, 0x1f000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_SAKURANRF_UF2, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_SAKURANRF_UF2_NRF52833, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ADC_LOG_LEVEL_OFF, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CLOCK_CONTROL_PWM, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CLOCK_CONTROL_PWM_INIT_PRIORITY, 51);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CONSOLE_INPUT_MAX_LINE_LEN, 256);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_I2C_NRFX_TRANSFER_TIMEOUT, 25);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RETAINED_MEM_NRF_RAM_CTRL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RETAINED_MEM_ZEPHYR_RAM, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NVS_INIT_BAD_MEMORY_REGION, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOG_PROCESS_THREAD_SLEEP_MS, 50);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DEVICE_PID, 0x7692);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_WORKQUEUE_STACK_SIZE, 512);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_HID_LOG_LEVEL_WRN, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_HID_LOG_LEVEL, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HID_INTERRUPT_EP_MPS, 64);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_HID_POLL_INTERVAL_MS, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_HID_REPORTS, 256);
