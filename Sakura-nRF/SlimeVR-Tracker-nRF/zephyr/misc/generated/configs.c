...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BATTERY_USE_REG_LDO_MAPPING, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BATTERY_LOW_RUNTIME_THRESHOLD, 10800000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LED_RGB_COLOR, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LED_DEFAULT_COLOR_R, 10000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LED_DEFAULT_COLOR_G, 6385);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LED_DEFAULT_COLOR_B, 7259);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SENSOR_LP_TIMEOUT, 300000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USE_SENSOR_CLOCK, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PM_SRAM_SIZE, 0x3f000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_SAKURANRF_UF2_NRF52833_CHRYSALIS, 1);
